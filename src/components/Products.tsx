    ...
    const productCategories = [
        {
            ...
            description:
                "Our signature namkeen collection with authentic flavors",
            products: [
                "Ratlami Sev",
                "Laung Sev",
                "Ujjaini Sev",
        ...
        },
        {
            ...
            products: [
                ...
                "Premium Laung Sev",
                "Premium Ujjaini Sev",
                "Premium Bank Fiki Sev",
                "Premium Khatta Mitha",
                "Premium Tikha Mixture",
                "Premium Navratn",
                "Premium Makka Mixture",
            ],
        ...
        },
        {
            title: "Shudh Satwik",
            description:
                "Pure vegetarian products made with traditional methods",
            products: [
                "Satwik Ratlami Sev",
                "Satwik Laung Sev",
                "Satwik Ujjaini Sev",
                "Satwik Bank Fiki Sev",
                "Satwik Khatta Mitha",
                "Satwik Tikha Mixture",
                "Satwik Navratn",
                "Satwik Makka Mixture",
            ],
                    ...
                    {productCategories.map((category, index) => (
                        ...
                        >
                            <CardContent className="p-6">
                                <div className="mb-4">
                                    <Badge
                                        className={`${category.badgeColor} text-white font-poppins mb-3`}
                                    >
                                        {category.title}
                                    </Badge>
                                ...
                                <div className="mt-6 pt-4 border-t border-warmBrown/10 flex items-center justify-between">
                                    <p className="text-xs text-warmBrown/60 font-merriweather">
                                        Available in multiple sizes: 250g, 500g
                                        & 1kg
                                    </p>
