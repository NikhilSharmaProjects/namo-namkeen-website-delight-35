          ...
          <div className="flex-1 text-center lg:text-left lg:pr-12 mb-8 lg:mb-0 order-2 lg:order-1">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins text-warmBrown leading-tight">
                <span className="block">Authentic Indori Namkeen</span>
                <span className="block text-saffron">Fresh From Indore To Your Doorstep</span>
              </h1>
              
              {/* Rich SEO Content */}
              <div className="space-y-4 text-lg md:text-xl text-warmBrown/80 font-merriweather max-w-2xl mx-auto lg:mx-0">
                <p>
                  Since 1990, <strong>Namo Namkeen</strong> has been crafting authentic Indore namkeen using traditional recipes passed down through generations. Our premium quality snacks are made with the finest ingredients, absolutely no preservatives, and delivered fresh to your doorstep across India.
                </p>
                
                <p>
                  From our signature <strong>Ratlami Sev</strong> to mouth-watering <strong>Khatta Meetha</strong>, each product embodies the rich culinary heritage of Indore. We maintain the highest hygiene standards and use only pure groundnut oil in our Satwik range, ensuring every bite delivers authentic taste and superior quality.
                </p>
              </div>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-4 my-6">
                <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full shadow-sm">
                  ...
                  <span className="text-sm font-semibold text-warmBrown">FSSAI Certified</span>
                </div>
                <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full shadow-sm">
                  <Award className="w-5 h-5 text-gold" />
                  <span className="text-sm font-semibold text-warmBrown">30+ Years Trust</span>
                </div>
                <div className="flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full shadow-sm">
                  <Truck className="w-5 h-5 text-blue-600" />
                  <span className="text-sm font-semibold text-warmBrown">Pan India Delivery</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center lg:justify-start gap-8 pt-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-warmBrown/70">Customer Rating</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold font-poppins text-warmBrown">50+</div>
                  <div className="text-sm text-warmBrown/70">Product Varieties</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold font-poppins text-warmBrown">5000+</div>
                  <div className="text-sm text-warmBrown/70">Happy Families</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-saffron/10 to-turmeric/10 p-6 rounded-2xl border border-saffron/20">
                ...
                <p className="text-warmBrown/80 font-merriweather italic mb-4">
                  "Best Ratlami Sev I've ever tasted! Reminds me of my childhood visits to Indore. The quality and freshness are unmatched."
                </p>
                <p className="font-bold text-warmBrown">- Priya Sharma, Mumbai</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-chili/10 to-saffron/10 p-6 rounded-2xl border border-chili/20">
                ...
                <p className="text-warmBrown/80 font-merriweather italic mb-4">
                  "Authentic taste, perfect packaging, quick delivery. Namo Namkeen has become our family's go-to for all festivals and celebrations!"
                </p>
                <p className="font-bold text-warmBrown">- Rajesh Patel, Delhi</p>
              </div>
            </div>
          </div>
        </div>
