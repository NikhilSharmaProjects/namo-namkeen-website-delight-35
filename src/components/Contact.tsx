  ...
  const contactInfo = [
    {
      ...
      title: "Our Address",
      details: ["65-A, Nagin Nagar", "Indore (M.P.), India"]
    },
    {
      icon: <Phone className="w-6 h-6" />,
      title: "Call Us",
      details: ["+91 88238 18001", "Customer Care Available"]
    },
    {
      icon: <Mail className="w-6 h-6" />,
      title: "Email Us",
      details: ["namoindiaifoodindustriess@gmail.com", "Quick Response Guaranteed"]
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Online",
      details: ["www.namoindianamkeen.com", "Follow us on Social Media"]
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-saffron to-turmeric text-white p-8 rounded-2xl">
              <h3 className="font-poppins font-bold text-2xl mb-4">Visit Our Factory</h3>
              <p className="font-merriweather mb-4">
                Experience our manufacturing process firsthand and see how we maintain 
                the highest quality standards in every product we make.
              </p>
