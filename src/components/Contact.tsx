...
const Contact = () => {
    const contactInfo = [
        ...
        },
        {
            ...
            details: [
                "www.namoindianamkeen.com",
                "Namo India Namkeen (Facebook)",
            ],
        },
    ];
            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-xl text-warmBrown/80 max-w-3xl mx-auto font-merriweather">
                        Have questions about our products? Want to place a bulk
                        order? We'd love to hear from you and help you
                        experience the authentic taste of Indore.
                    </p>
                    ...
                    <div className="space-y-8">
                                            ...
                                            <div>
                                                ...
                                                {info.details.map(
                                                    (detail, idx) => (
                                                        <p
                                                            key={idx}
                                                            className="font-merriweather text-warmBrown/70 text-sm"
                                                        >
                                                            {detail}
                                                        </p>
                                                    )
                        ...
                        <div className="bg-gradient-to-br from-saffron to-turmeric text-white p-8 rounded-2xl">
                            ...
                            <p className="font-merriweather mb-4">
                                Experience our manufacturing process firsthand
                                and see how we maintain the highest quality
                                standards in every product we make using premium
                                ingredients and traditional recipes.
                            </p>
                            <div className="flex items-center gap-2 text-sm">
                                <Clock className="w-4 h-4" />
                                <span>
                                    Factory tours available on appointment
                                </span>
                            </div>
                            ...
                            <CardContent className="p-8">
                                ...
                                <div className="mt-6 pt-6 border-t border-turmeric/20">
                                    ...
                                    <p className="text-center text-xs text-saffron font-poppins mt-2 font-semibold">
                                        Namo is not just a name, it's a promise
                                        of good quality
                                    </p>
                                </div>
                            </CardContent>
